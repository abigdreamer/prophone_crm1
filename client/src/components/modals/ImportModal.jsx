    ...
    <div>
      <div
        ...
        style={{
          ...
          background: dragging ? T.accent + "06" : T.bg,
        }}
      >
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          {["ignore", "update"].map(opt => (
            <button
              key={opt}
              onClick={() => setDuplicateAction(opt)}
              style={{
          ...
          <tbody>
            {preview.map((row, ri) => (
              <tr key={ri} style={{ borderBottom: `1px solid ${T.border}` }}>
                {mapped.map(m => (
                  <td key={m.header} style={{
                    padding: "7px 12px", color: T.dim,
...
function StepSummary({ result, onClose, onStartOver }) {
  ...
  return (
    <div style={{ textAlign: "center" }}>
      ...
      {errors?.length > 0 && (
        <div style={{
          textAlign: "left", maxHeight: 140, overflowY: "auto",
          border: `1px solid ${T.border}`, borderRadius: 8, marginBottom: 20,
        }}>
          <div style={{ padding: "8px 12px", borderBottom: `1px solid ${T.border}`, background: T.surface }}>
            <span style={{ fontSize: 10, fontWeight: 700, color: T.amber, letterSpacing: "0.06em" }}>
          ...
          {errors.length > 20 && (
            <div style={{ padding: "7px 12px", fontSize: 11, color: T.muted }}>
...
export default function ImportModal({ onClose, clientId, pool, onImported }) {
  ...
  const canAdvance =
    step === 1 ? mapping.some(m => m !== "__skip__") : true;
  ...
  return (
    ...
    >
      <div style={{
        background: T.card, border: `1px solid ${T.border}`,
        borderRadius: 14, width: 680, maxWidth: "100%",
        ...
        <div style={{
          ...
          padding: "18px 22px 16px", borderBottom: `1px solid ${T.border}`, flexShrink: 0,
        }}>
          <div>
            <div style={{ fontSize: 15, fontWeight: 700, color: T.text }}>Import Contacts</div>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "20px 22px" }}>
          ...
          {importError && (
            <div style={{
              ...
              color: T.red, fontSize: 12, display: "flex", alignItems: "center", gap: 8,
            }}>
              ...
              {step < 2 && (
                <button
                  ...
                  style={{
                    ...
                    background: canAdvance ? T.accent : T.surface,
                    border: "none", color: canAdvance ? "#fff" : T.muted,
              ...
              {step === 2 && (
                <button
                  ...
                  style={{
                    ...
                    padding: "9px 22px", borderRadius: 7,
                    background: importing ? T.accent + "80" : T.accent,
