      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 7, marginRight: 4, flexShrink: 0 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 8, color: T.navMuted, fontWeight: 700, letterSpacing: "0.05em" }}>PROPHONE</div>
          </div>
        </div>
        ...
        <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 10 }}>
          {search && (
            <div style={{
              ...
              <svg viewBox="0 0 24 24" fill="none" stroke={T.accent} strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"
                style={{ width: 10, height: 10, opacity: 0.9 }}>
                <circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line>
              </svg>
              <span style={{ fontSize: 11, fontWeight: 700, color: T.accent, letterSpacing: '0.01em' }}>"{search}"</span>
              <button
                onClick={() => setSearch("")}
                style={{ background: "none", border: "none", color: T.accent, cursor: "pointer", fontSize: 11, padding: 0, marginLeft: 2, display: 'flex' }}
              >✕</button>
            </div>
          )}
          <ThemeSwitcher />
      ...
      <div style={{ flex: 1, display: "flex", overflow: "hidden", position: "relative" }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", minWidth: 0 }}>
              ...
              {[
                ...
                >
                  <span style={{
                    ...
                    background: c, opacity: viewMode === mode ? 1 : 0.3,
                  }} />
                  {label}
                </button>
              ))}
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: 20, position: "relative" }}>
            ...
            {isContacts && selected ? (
              <ContactDetailPanel contact={selected} onUpdate={handleUpdate} currentUser={currentUser} />
            ) : (
              <Routes>
        ...
        {charted && (
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ fontSize: 11, fontWeight: 800, color: T.text, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Lead Lifecycle</div>
              <button
