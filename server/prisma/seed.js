...
async function main() {
  ...
  // ── Prospect Contacts (upsert — safe to re-run) ───────────────────────────
  const john = await prisma.contact.upsert({
    where: { email: 'john@towpro.com' },
    update: {},
    create: {
  ...
  const maria = await prisma.contact.upsert({
    where: { email: 'maria@fastway.com' },
    update: {},
    create: {
  ...
  const dave = await prisma.contact.upsert({
    where: { email: 'dave@bayauto.com' },
    update: {},
    create: {
  ...
  const lisa = await prisma.contact.upsert({
    where: { email: 'lisa@cityfleet.com' },
    update: {},
    create: {
  ...
  const chris = await prisma.contact.upsert({
    where: { email: 'chris@pacific.com' },
    update: {},
    create: {
  ...
  const nadia = await prisma.contact.upsert({
    where: { email: 'nadia@elite.com' },
    update: {},
    create: {
  ...
  const brian = await prisma.contact.upsert({
    where: { email: 'brian@caltow.com' },
    update: {},
    create: {
  ...
  const amyn = await prisma.contact.upsert({
    where: { email: 'amy@roadpros.com' },
    update: {},
    create: {
  ...
  const kevin = await prisma.contact.upsert({
    where: { email: 'kevin@xpress.com' },
    update: {},
    create: {
  ...
  // ── Client Contacts (upsert — safe to re-run) ─────────────────────────────
  const brandon = await prisma.contact.upsert({
    where: { email: 'brandon@foxtow.com' },
    update: {},
    create: {
  ...
  const jenny = await prisma.contact.upsert({
    where: { email: 'jenny@foxtow.com' },
    update: {},
    create: {
  ...
  const ray = await prisma.contact.upsert({
    where: { email: 'ray@baytow.com' },
    update: {},
    create: {
  ...
  const marco = await prisma.contact.upsert({
    where: { email: 'marco@sanpabloauto.com' },
    update: {},
    create: {
  ...
  const tina = await prisma.contact.upsert({
    where: { email: 'tina@spfleet.com' },
    update: {},
    create: {
  ...
  // ── Activities (wipe & re-seed so they don't stack up) ────────────────────
